...
sap.ui.define([
		...
		"es4products/model/grouper",
		"es4products/model/GroupSortState"
		...
		return BaseController.extend("es4products.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("es4products.view.ViewSettingsDialog", this);
