sap.ui.define([
		...
		return BaseObject.extend("es4products.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias es4products.model.ListSelector
			 */
			 ...
			 * @return {es4products.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
